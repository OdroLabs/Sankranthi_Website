    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          IMG("business_hero_image", "Hero photo — main", "Large arched photo on the right of the hero."),
          IMG("business_hero_side_image", "Hero photo — side", "Narrow photo beside the main hero photo (e.g. a nail treatment close-up)."),
          ...
          IMG("business_about_image", "\"Our Story\" photo 1", "The larger of the two photos beside the story text."),
          IMG("business_about_image_2", "\"Our Story\" photo 2", "The smaller of the two photos beside the story text."),
          ...
          IMG("business_opportunity_image", "\"Opportunity\" photo"),
          ...
          IMG("business_mission_image", "Mission statement background photo"),
          T("business_services_title", "Services heading"),
          IMG("business_service_1_image", "Service photo 1"),
          T("business_service_1_label", "Service label 1"),
          IMG("business_service_2_image", "Service photo 2"),
          T("business_service_2_label", "Service label 2"),
          IMG("business_service_3_image", "Service photo 3"),
          T("business_service_3_label", "Service label 3"),
          IMG("business_service_4_image", "Service photo 4"),
          T("business_service_4_label", "Service label 4"),
          T("business_cta_title", "Final call-to-action heading"),
          TA("business_cta_body", "Final call-to-action body"),
          IMG("business_cta_image", "Final call-to-action photo"),
